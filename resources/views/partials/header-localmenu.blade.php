...
<nav class="bg-uh-bg-1 pt-1 dark:bg-gray-900">
    <div class="hidden layout-container sm:flex px-4 sm:px-6 lg:px-8 croll-smooth hover:scroll-auto">
        ...
        >
            ...
            <span class="@if ($routeName === 'dashboard') text-white @endif">{{ __('Dashboard') }}</span>
        </a>
        ...
        @role('admin')
            ...
            >
                @svg('icon-link', 'mr-1')
                <span class="@if ($routeName === 'dashboard.allurl') text-white @endif">{{ __('URL List') }}</span>
            </a>
            ...
            >
                ...
                <span class="@if ($routeName === 'user.index') text-white @endif">{{ __('User List') }}</span>
            </a>
