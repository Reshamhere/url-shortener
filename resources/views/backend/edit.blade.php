...
<main class="flex flex-wrap min-h-screen"> <!-- min-h-screen added here for the full screen -->
    ...
    <!-- Ensure this div takes the rest of the available space -->
    <div class="w-full md:w-8/12 lg:w-6/12 mt-5 md:mt-0 md:ml-4 flex-grow"> 
